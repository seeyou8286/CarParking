...
import com.network.jiufen.carparking.carparking.adapter.GuideViewPagerAdapter;
...
public class WelcomeGuideActivity extends Activity implements OnClickListener {
	...
	protected void onPause() {
		...
		SpUtils.putBoolean(WelcomeGuideActivity.this, DictionaryUtil.FIRST_OPEN, true);
		finish();
	}
